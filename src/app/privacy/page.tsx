  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 px-4 py-12">
      ...
      <ColorBlock color="cream" padding="lg" className="space-y-4 text-sm leading-relaxed text-muted-foreground">
        ...
        <h2 className="text-lg font-extrabold text-foreground">Information we collect</h2>
        ...
        <h2 className="text-lg font-extrabold text-foreground">How we use information</h2>
        <ul className="list-disc space-y-2 pl-5">
        ...
        <h2 className="text-lg font-extrabold text-foreground">Payment processing</h2>
        <p>
        ...
        <h2 className="text-lg font-extrabold text-foreground">Cookies & analytics</h2>
        <p>
        ...
        <h2 className="text-lg font-extrabold text-foreground">Your rights</h2>
        <p>
