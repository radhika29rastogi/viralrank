  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 px-4 py-12">
      ...
      <ColorBlock color="cream" padding="lg" className="space-y-4 text-sm leading-relaxed text-muted-foreground">
        ...
        <h2 className="text-lg font-extrabold text-foreground">Cancellation before processing</h2>
        <p>
        ...
        <h2 className="text-lg font-extrabold text-foreground">After service processing begins</h2>
        <p>
        ...
        <h2 className="text-lg font-extrabold text-foreground">Duplicate or accidental payments</h2>
        <p>Duplicate or accidental payments will be reviewed on a case-by-case basis.</p>
        <h2 className="text-lg font-extrabold text-foreground">How to request a refund</h2>
        <p>
        ...
        <h2 className="text-lg font-extrabold text-foreground">Processing timeframe</h2>
        <p>
        ...
        <h2 className="text-lg font-extrabold text-foreground">No ranking guarantees</h2>
        <p>
