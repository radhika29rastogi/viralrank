...
export const USERNAME_PARSE_EXAMPLES: Array<{ input: string; username: string | null }> = [
  ...
  { input: "https://www.instagram.com/vrindakivaani/", username: "vrindakivaani" },
  { input: "@instagram", username: "instagram" },
  ...
  { input: "instagram.com/vrindakivaani", username: "vrindakivaani" },
