  ...
  return (
    <section className="space-y-6">
      <div className="text-center">
        ...
        <p className="mt-3 text-muted-foreground">Pick a lane. Or don&apos;t. Go viral in all of them.</p>
      </div>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {FLAVOR_CATEGORIES.map((cat) => (
          <Link
            ...
            className={cn(
              "flex min-h-28 items-center justify-center rounded-3xl border-[4px] border-border px-4 py-8 text-center text-2xl font-extrabold text-on-accent shadow-[4px_4px_0_#000] transition-transform hover:-translate-y-0.5",
              cat.color,
